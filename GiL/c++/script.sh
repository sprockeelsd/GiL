#!/bin/sh
    ...
    /home/amdiels/Bureau/install_name_tool/build/install_name_tool -change gecode.framework/Versions/49/gecode /Library/Frameworks/gecode.framework/Versions/49/gecode libgecode.dylib
